...
def silla(gamma = -1, mu = 1):
    ...
    guardar() if guardar else None
    plt.show() if plot else None
    plt.clf()

def nodo_estable_1(gamma=-1):
...
def nodo_estable_2(gamma = -2, mu = -1):
