...
u_opt = fmin(f, x0=0.5, xtol=1e-4, disp=1)
...
def solucionario(u=0):
    ...
    solucion = solve_ivp(SIR, [intervalo_control[1],intervalo_tiempo[1]], [s2[-1],i2[-1],r2[-1]], t_eval=t_eval3, method='RK23')
